(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".popular__slider") && window.innerWidth <= 767.98) new core(".popular__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.3,
        ...
        if (document.querySelector(".house__slider")) new core(".house__slider", {
            ...
            navigation: {
                prevEl: ".house__arrow_left",
                nextEl: ".house__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.36,
        ...
        if (document.querySelector(".review__slider")) new core(".review__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(".milde-header__button")) targetElement.closest("._spoller-init").classList.toggle("_pb");
        const map = document.querySelector(".map__house");
        const closeOne = document.querySelectorAll("._close-open");
        map.querySelectorAll(".house__item:not(._close-open)");
        if (targetElement.closest(".map__tip")) map.classList.add("_active");
        ...
        if (targetElement.closest(".map__tip_1")) {
            ...
            if (document.querySelector("#house1").classList.contains("_close-open")) document.querySelector("#house1").classList.remove("_close-open");
        ...
        if (targetElement.closest(".map__tip_2")) {
            map.classList.add("_active");
            if (document.querySelector("#house2").classList.contains("_close-open")) document.querySelector("#house2").classList.remove("_close-open");
            document.querySelector("#house1").classList.add("_close-open");
            document.querySelector("#house3").classList.add("_close-open");
        }
        if (targetElement.closest(".map__tip_3")) {
            map.classList.add("_active");
            if (document.querySelector("#house3").classList.contains("_close-open")) document.querySelector("#house3").classList.remove("_close-open");
            document.querySelector("#house1").classList.add("_close-open");
            document.querySelector("#house2").classList.add("_close-open");
        }
        if (targetElement.closest(".m")) {
            ...
            if (document.querySelector(".ymaps-2-1-79-map")) document.querySelector(".ymaps-2-1-79-map").remove();
        }
    ...
    for (let i = 0; i < populartext.length; i++) {
        ...
        if (el.clientHeight <= 70) link.style.display = "none"; else {
    ...
    if (swiper.childElementCount % 2 == 0) swiper.lastElementChild.id = "gridrows";
    ymaps.ready((function() {
        let myMap = new ymaps.Map("map", {
            center: [ 56.813895228303046, 34.901987332335786 ],
            zoom: 7,
